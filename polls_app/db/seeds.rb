...
ActiveRecord::Base.transaction do
  User.destroy_all
    user1 = User.create!(username: 'Travis')
    user2 = User.create!(username: 'Donald')
    user3 = User.create!(username: 'McNick')
    user4 = User.create!(username: 'OldNick')
    user5 = User.create!(username: 'BigGreen')
